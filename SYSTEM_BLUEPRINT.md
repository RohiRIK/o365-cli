...
- **[SWISS-ARMY] Custom Role Forensic:** Audit custom directory roles for excessive permissions.
...
- **[SWISS-ARMY] SharePoint Storage Optimizer:** Identify large, unused sites and old versions.
- **[SWISS-ARMY] Power Platform Guard:** Monitor for shadow environments and unused flows.
...
- **[SWISS-ARMY] Forensic Timeline Generator:** Build event maps for specific identities.