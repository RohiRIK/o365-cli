...
impl AuthManager {
    ...
    pub async fn login(&self) -> Result<String> {
        ...
        let (auth_url, csrf_token) = client
            ...
            .add_scope(Scope::new("DeviceManagementConfiguration.Read.All".to_string()))
            .add_scope(Scope::new("DeviceManagementApps.Read.All".to_string()))
            .add_scope(Scope::new("DeviceManagementServiceConfig.Read.All".to_string()))
            .add_scope(Scope::new("DeviceManagementManagedDevices.Read.All".to_string()))
