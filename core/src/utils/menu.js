 ...
 */
export function getCategoryChoices(taskIds, showAll = true) {
 ...
 */
export function getModulesInCategory(taskIds, category, showAll = true) {
    if (category === "sys") {
        return [
 ...
 */
export function getAllModuleChoices(showAll = true) {
