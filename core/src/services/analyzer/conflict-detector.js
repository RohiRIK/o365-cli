...
export class ConflictDetector {
    ...
    formatConflicts(conflicts) {
        ...
        if (critical.length > 0) {
            ...
            for (const conflict of critical) {
                ...
                if (conflict.affectedScope.users)
                    report += `  - Users: ${conflict.affectedScope.users}\n`;
                if (conflict.affectedScope.apps)
                    report += `  - Apps: ${conflict.affectedScope.apps}\n`;
     ...
     */
    calculatePlatformOverlap(p1, p2) {
     ...
     */
    detectContradiction(p1, p2, overlap) {
        ...
        if (p1Blocks !== p2Blocks) {
            ...
            return {
                ...
                affectedScope: {
                    ...
                    platforms: overlap.platformOverlap > 0 ? `${overlap.platformOverlap}% platform overlap` : undefined,
                },
            };
        }
        return null;
     ...
     */
    detectRedundancy(p1, p2, overlap) {
