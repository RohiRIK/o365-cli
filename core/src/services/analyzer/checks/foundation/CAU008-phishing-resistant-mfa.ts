...
export function createCAU008Check(helpers: CheckHelpers): BaselineCheck {
  return {
    id: "CAU008",
    name: "Require Phishing-Resistant MFA for Admins",
    description:
      "Prevents admin takeover via MFA fatigue or SIM swaps using FIDO2/Windows Hello.",
    priority: 1,
    pillar: "Foundation",
    recommendation:
      "Require 'Authentication Strength' (FIDO2/Passkey) for all administrator roles.",
