...
export function createCAU025Check(helpers: CheckHelpers): BaselineCheck {
  return {
    id: "CAU025",
    name: "Require Modern Authentication Clients",
    description:
      "Blocks legacy clients that don't support OAuth 2.0 or modern authentication protocols.",
    priority: 2,
    pillar: "Foundation",
    recommendation:
      "Create a policy allowing only modern authentication clients (mobile apps, browsers).",
