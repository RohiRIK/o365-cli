 ...
 */
export function createCAU020Check(helpers) {
    return {
        id: "CAU020",
        ...
        priority: 1,
        pillar: "Foundation",
        recommendation: "Create a policy blocking access from anonymous IP addresses and Tor exit nodes.",
  ...
  "signInRiskLevels": ["medium", "high"]  // Includes anonymous IP detection
        ...
        evaluate(policies) {
            ...
            for (const policy of policies) {
                ...
                const hasLocationBlock = policy.conditions?.locations?.includeLocations?.includes("All") &&
                ...
                const hasRiskDetection = policy.conditions?.signInRiskLevels &&
