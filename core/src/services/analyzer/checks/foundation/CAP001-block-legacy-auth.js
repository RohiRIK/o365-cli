 ...
 */
export function createCAP001Check(helpers) {
    return {
        // ===== METADATA =====
        id: "CAP001",
        name: "Block Legacy Authentication",
        description: "Legacy protocols (POP, IMAP, SMTP) bypass MFA and are used in 99% of password spray attacks.",
        priority: 1,
        pillar: "Foundation",
        recommendation: "Create a policy blocking 'Exchange ActiveSync' and 'Other clients' for all users.",
    ...
    "builtInControls": ["block"]
        ...
        evaluate(policies) {
            ...
            for (const policy of policies) {
                ...
                const hasLegacyClients = clientAppTypes.some((t) => ["exchangeActiveSync", "other"].includes(t));
