 ...
 */
export function createCAU019Check(helpers) {
    return {
        id: "CAU019",
      ...
      "id": "00000000-0000-0000-0000-000000000003"  // Certificate-based MFA
        ...
        evaluate(policies) {
            ...
            for (const policy of policies) {
                ...
                const targetsServiceAccounts = policy.conditions?.users?.includeGroups &&
                    policy.conditions.users.includeGroups.length > 0;
                const hasStrongAuth = policy.grantControls?.authenticationStrength !== null ||
