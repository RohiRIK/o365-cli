...
export function createCAD006Check(helpers: CheckHelpers): BaselineCheck {
  return {
    id: "CAD006",
    name: "Session Timeout for Sensitive Apps",
    description:
      "Enforces short session lifetimes for high-value apps to limit hijacking window.",
    priority: 2,
    pillar: "Zero Trust",
    recommendation:
      "Set sign-in frequency to 1-4 hours for HR, finance, and admin applications.",
