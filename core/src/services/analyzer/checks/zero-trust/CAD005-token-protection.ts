...
export function createCAD005Check(helpers: CheckHelpers): BaselineCheck {
  return {
    id: "CAD005",
    name: "Token Protection for Desktop Apps",
    description:
      "Binds authentication tokens to device, preventing theft and replay attacks.",
    priority: 3,
    pillar: "Zero Trust",
    recommendation:
      "Enable token protection for Windows devices accessing Office desktop apps.",
