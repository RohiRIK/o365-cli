...
export function createCAD002Check(helpers: CheckHelpers): BaselineCheck {
  return {
    id: "CAD002",
    ...
    pillar: "Zero Trust",
    recommendation:
      "Require 'Approved Client App' and 'App Protection Policy' for iOS/Android.",
  ...
  "grantControls": {
    ...
    evaluate(policies: Policy[]): PolicyMatch[] {
      ...
      for (const policy of policies) {
        ...
        const requiresMAM = helpers.meetsGrantControls(
          policy,
