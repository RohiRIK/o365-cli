...
export function createCAU021Check(helpers: CheckHelpers): BaselineCheck {
  return {
    id: "CAU021",
    name: "Geofencing - Block Untrusted Countries",
    description:
      "Blocks authentication from countries where organization has no presence.",
    priority: 2,
    pillar: "Risk-Based",
    recommendation:
      "Create a Named Location with allowed countries and block access from all others.",
