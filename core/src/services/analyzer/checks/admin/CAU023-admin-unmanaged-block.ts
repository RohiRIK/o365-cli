...
export function createCAU023Check(helpers: CheckHelpers): BaselineCheck {
  return {
    id: "CAU023",
    name: "Block Admin Access from Unmanaged Devices",
    description:
      "Prevents administrators from accessing portals on personal or unmanaged devices.",
    priority: 1,
    pillar: "Administration",
    recommendation:
      "Create a policy blocking admin portal access unless device is compliant or domain-joined.",
