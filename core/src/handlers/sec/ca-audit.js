...
import { auditCAPolicies, summarizeAssignments, summarizeConditions, summarizeGrantControls, flattenPolicyForExport } from "../../commands/sec/ca-audit";
import { IPC } from "../../utils/ipc";
import chalk from "chalk";
export async function fetchCAPolicies() {
    return await GraphService.fetchAll("/identity/conditionalAccess/policies");
}
class CaAuditHandler {
    taskId = "sec:ca-audit";
