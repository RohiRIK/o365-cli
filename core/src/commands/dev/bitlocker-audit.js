 ...
 */
export async function auditBitLocker(dryRun = true) {
    ...
    try {
        ...
        const devices = await GraphService.fetchAll(`/deviceManagement/managedDevices?$filter=operatingSystem eq 'Windows'`, "id,deviceName,userPrincipalName,isEncrypted,encryptionState,managedDeviceName,lastSyncDateTime");
