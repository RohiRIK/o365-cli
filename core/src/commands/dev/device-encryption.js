 ...
 */
export async function auditDeviceEncryption(dryRun = true) {
    ...
    try {
        ...
        const devices = await GraphService.fetchAll(`/deviceManagement/managedDevices`, "id,deviceName,operatingSystem,osVersion,isEncrypted,userPrincipalName");
