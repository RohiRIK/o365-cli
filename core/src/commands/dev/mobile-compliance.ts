 ...
 */
export async function auditMobileCompliance(dryRun: boolean = true) {
  ...
  try {
    ...
    const devices = await GraphService.fetchAll(
      ...
      "id,deviceName,operatingSystem,osVersion,complianceState,lastSyncDateTime,userPrincipalName,jailBroken",
      {
