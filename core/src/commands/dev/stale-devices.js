 ...
 */
export async function detectStaleDevices(days = 90, dryRun = true) {
    ...
    try {
        ...
        const devices = await GraphService.fetchAll(`/deviceManagement/managedDevices`, "id,deviceName,operatingSystem,osVersion,lastSyncDateTime,userPrincipalName,complianceState");
