 ...
 */
export async function auditExternalUserAccess(dryRun = true) {
    ...
    try {
        ...
        const guestUsers = await GraphService.fetchAll(`/users`, "id,userPrincipalName,displayName,userType,createdDateTime,signInActivity", {
