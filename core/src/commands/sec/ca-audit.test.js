...
import { summarizeAssignments, summarizeConditions, summarizeGrantControls, auditCAPolicies } from "./ca-audit";
// Mock GraphService
...
describe("CA Audit Module", () => {
    ...
    describe("Registration & Fetching", () => {
        ...
        it("should fetch CA policies from Graph API", async () => {
            GraphService.fetchAll.mockResolvedValue(mockPolicies);
