 ...
 */
export async function cleanupStaleDevices(inactivityDays = 90, dryRun = true) {
    ...
    try {
        ...
        const managedDevices = await GraphService.fetchAll(`/deviceManagement/managedDevices`, "id,deviceName,userPrincipalName,operatingSystem,lastSyncDateTime,complianceState,managedDeviceOwnerType");
        ...
        const entraDevices = await GraphService.fetchAll(`/devices`, "id,displayName,operatingSystem,approximateLastSignInDateTime,accountEnabled");
